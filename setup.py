...
versionpy = DIR / 'miyadaiku_theme_popper_js/__version__.py'
version = re.search(r'"([\d.]+)"', versionpy.read_text())[1]


setup(
    name="miyadaiku_theme_popper_js",
    version=version,
    ...
    url='https://github.com/miyadaiku/miyadaiku_theme_popper_js',
    project_urls={
        'Miyadaiku': 'https://miyadaiku.github.io/',
    },

    packages=list(setuputils.list_packages(DIR, 'miyadaiku_theme_popper_js')),
    package_data={
